...
Version 7.5 - January 2026 (Cleaned)

Complete vocabulary dictionary based on computational analysis of 78,619 words.
Vocabulary entries: 1,012 core + frequency-verified compounds
Direct vocabulary coverage: ~68% of corpus

NOTE: Removed mechanical morpheme combinations (v7.6-7.9) that produced
nonsensical translations like "water-root-water-ADJ". Focus on quality
