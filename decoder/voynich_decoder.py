...
VOCAB = {
    ...
    # =========================================================================
    # SECTION 47: EXTENDED MORPHOLOGICAL COMPOUNDS (3-5 occurrences)
    # Long-tail vocabulary expansion - January 2026
    # =========================================================================

    # 5x occurrence compounds
    'ksheody': ('vessel-water-flow-ADJ', 4),
    'ykchor': ('and-vessel-SICK', 4),
    'qokod': ('vessel-vessel-a', 4),
    'pchodaiin': ('for-flower-leaf.NOM', 4),
    'orom': ('of-heart-EYE', 4),
    'ochol': ('of-flower', 4),
    'ypchey': ('and-for-with-flow', 4),
    'qocthey': ('vessel-condition-flow', 4),
    'chtol': ('flower-time-oil', 4),
    'sshey': ('root-water-flow', 4),
    'eedy': ('flow-flowing', 4),
    'pchdar': ('for-flower-GIVE', 4),
    'ofchdy': ('beast-with-ADJ', 4),
    'cher': ('flower-tree', 4),
    'shs': ('water-root', 4),
    'qolkain': ('vessel-oil-vessel.ACC', 4),
    'qokchd': ('vessel-with-leaf', 4),
    'pchody': ('for-flower-ADJ', 4),
    'aithy': ('water-time-ADJ', 4),
    'chkedy': ('flower-vessel-flowing', 4),
    'lkol': ('extract-vessel-oil', 4),
    'ckhhy': ('with-vessel-ADJ', 4),
    'lain': ('extract.ACC', 4),
    'qoteo': ('basin-earth', 4),
    'los': ('extract-bone', 4),
    'podaiin': ('for-of-leaf.NOM', 4),
    'ldar': ('extract-GIVE', 4),
    'ckheody': ('with-vessel-flow-ADJ', 4),
    'chockhey': ('flower-with-vessel-flow', 4),
    'qool': ('vessel-oil', 4),
    'kcheey': ('vessel-flower-flow', 4),
    'odair': ('of-leaf-tree', 4),
    'dalchdy': ('GIVE.PAST-flower-ADJ', 4),
    'chaly': ('flower-high-ADJ', 4),
    'dalar': ('GIVE.PAST-high-tree', 4),
    'chotam': ('flower-time.GEN', 4),
    'dalal': ('GIVE.PAST-high', 4),
    'chekchy': ('flower-vessel-with-ADJ', 4),
    'kcheody': ('vessel-flower-flow-ADJ', 4),
    'psheody': ('for-water-flow-ADJ', 4),
    'kody': ('vessel-a-ADJ', 4),
    'lkeol': ('extract-vessel-oil', 4),
    'otodaiin': ('star-of-leaf.NOM', 4),
    'qokeeedy': ('vessel-flow-flowing', 4),
    'shchy': ('water-with-ADJ', 4),
    'cheoty': ('flower-of-time-ADJ', 4),
    'otes': ('star-bone', 4),
    'otarar': ('star-tree-tree', 4),
    'oeey': ('of-flow', 4),
    'csedy': ('with-root-flowing', 4),
    'olkol': ('oil-vessel-oil', 4),
    'oin': ('of-in', 4),
    'lom': ('extract-EYE', 4),
    'chckhal': ('flower-with-vessel-high', 4),
    'okaral': ('container-tree-high', 4),
    'chetain': ('flower-time.ACC', 4),
    'olam': ('oil.GEN', 4),
    'otechdy': ('star-flow-with-ADJ', 4),
    'pchedal': ('for-flower-GIVE.PAST', 4),
    'cheedar': ('flower-flow-GIVE', 4),
    'pcheor': ('for-flower-heart', 4),
    'shekain': ('water-vessel.ACC', 4),
    'lkeeody': ('extract-vessel-flow-ADJ', 4),
    'lkchdy': ('extract-vessel-with-ADJ', 4),
    'qotched': ('basin-with-flow-leaf', 4),
    'ail': ('water-extract', 4),

    # 4x occurrence compounds
    'sory': ('root-heart-ADJ', 4),
    'chtaiin': ('flower-time.NOM', 4),
    'oksho': ('container-water', 4),
    'shodain': ('water-of-leaf.ACC', 4),
    'shoaiin': ('water-of.NOM', 4),
    'kechy': ('vessel-with-ADJ', 4),
    'shan': ('water.ACC', 4),
    'chyky': ('flower-ADJ-vessel-ADJ', 4),
    'shty': ('water-time-ADJ', 4),
    'qoteeey': ('basin-flow-flow', 4),
    'shom': ('water-EYE', 4),
    'eeor': ('flow-heart', 4),
    'shkaiin': ('water-vessel.NOM', 4),
    'ksheo': ('vessel-water-flow', 4),
    'kshody': ('vessel-water-ADJ', 4),
    'qotcheo': ('basin-with-flow', 4),
    'ykoiin': ('and-vessel.NOM', 4),
    'cholor': ('flower-oil-heart', 4),
    'qoair': ('vessel-water-tree', 4),
    'ckhal': ('with-vessel-high', 4),
    'pcheey': ('for-flower-flow', 4),
    'chot': ('flower-of-time', 4),
    'chotain': ('flower-time.ACC', 4),
    'chyty': ('flower-ADJ-time-ADJ', 4),
    'octhody': ('of-condition-ADJ', 4),
    'choraiin': ('flower-heart.NOM', 4),
    'odl': ('of-leaf-extract', 4),
    'sody': ('root-a-ADJ', 4),
    'teor': ('time-heart', 4),
    'ychy': ('and-with-ADJ', 4),
    'dydy': ('leaf-ADJ-ADJ', 4),
    'tshor': ('time-water-heart', 4),
    'ctholy': ('condition-oil-ADJ', 4),
    'dyky': ('leaf-ADJ-vessel-ADJ', 4),
    'chkchy': ('flower-vessel-with-ADJ', 4),
    'ckhody': ('with-vessel-a-ADJ', 4),
    'soy': ('root-of-ADJ', 4),
    'olo': ('oil-of', 4),
    'cpheor': ('with-for-heart', 4),
    'chodchy': ('flower-a-with-ADJ', 4),
    'okoy': ('container-of-ADJ', 4),
    'sheoy': ('water-flow-ADJ', 4),
    'cthain': ('condition.ACC', 4),
    'okoly': ('container-oil-ADJ', 4),
    'otshy': ('star-water-ADJ', 4),
    'otaiir': ('star.NOM-tree', 4),
    'oeeey': ('of-flow-flow', 4),
    'dalchedy': ('GIVE.PAST-with-flowing', 4),
    'odaiiin': ('of-leaf.NOM-in', 4),
    'teeedy': ('time-flow-flowing', 4),
    'ysaiin': ('and-root.NOM', 4),
    'ytchol': ('and-time-flower', 4),
    'chetchy': ('flower-time-with-ADJ', 4),
    'tchos': ('time-flower-bone', 4),
    'soin': ('root-of-in', 4),
    'chepchy': ('flower-for-with-ADJ', 4),
    'otcheor': ('star-with-heart', 4),
    'chepar': ('flower-for-tree', 4),
    'olsheol': ('oil-water-oil', 4),
    'otas': ('star-a-root', 4),
    'alaiin': ('high.NOM', 4),
    'loiin': ('extract.NOM', 4),
    'chekeedy': ('flower-vessel-flowing', 4),
    'tshdy': ('time-water-ADJ', 4),
    'kechdy': ('vessel-with-ADJ', 4),
    'cholky': ('flower-oil-vessel-ADJ', 4),
    'qorain': ('vessel-tree.ACC', 4),
    'sholy': ('water-oil-ADJ', 4),
    'keo': ('vessel-flow', 4),
    'olfchedy': ('oil-beast-with-flowing', 4),
    'qotcheedy': ('basin-with-flow-flowing', 4),
    'alshey': ('high-water-flow', 4),
    'olkeeo': ('oil-vessel-flow', 4),
    'chotor': ('flower-time-heart', 4),
    'sheokey': ('water-of-vessel-flow', 4),
    'ypar': ('and-for-tree', 4),
    'qoiiin': ('vessel-of.NOM', 4),
    'ckhedy': ('with-vessel-flowing', 4),
    'ofchey': ('beast-with-flow', 4),
    'okchar': ('container-with-tree', 4),
    'fchdy': ('beast-with-ADJ', 4),
    'qokdy': ('vessel-ADJ', 4),
    ...
    # =========================================================================
    # SECTION 49: HAPAX-ADJACENT COMPOUNDS (2 occurrences each)
    # Deep long-tail vocabulary - January 2026
    # =========================================================================

    'cphoy': ('with-for-of-ADJ', 3),
    'okchoy': ('container-with-of-ADJ', 3),
    'kos': ('vessel-bone', 3),
    'shoshy': ('water-root-water-ADJ', 3),
    'shoy': ('water-of-ADJ', 3),
    'oldain': ('oil-leaf.ACC', 3),
    'kchom': ('vessel-with-EYE', 3),
    'cthols': ('condition-oil-root', 3),
    'cpho': ('with-for-of', 3),
    'okay': ('container-vessel-ADJ', 3),
    'kokaiin': ('vessel-vessel.NOM', 3),
    'deeo': ('leaf-flow-of', 3),
    'koshey': ('vessel-root-water-flow', 3),
    'chtor': ('flower-time-heart', 3),
    'cfhar': ('with-beast-tree', 3),
    'chokeo': ('flower-vessel-flow', 3),
    'otoaiin': ('star-of.NOM', 3),
    'chodo': ('flower-a-of', 3),
    'darshol': ('GIVE-water-oil', 3),
    'sshor': ('root-water-heart', 3),
    'cth': ('condition', 3),
    'ykody': ('and-vessel-a-ADJ', 3),
    'yor': ('and-heart', 3),
    'kooiin': ('vessel-of.NOM', 3),
    'loeees': ('extract-flow-bone', 3),
    'cheaiin': ('flower-water.NOM', 3),
    'qoeor': ('vessel-flow-heart', 3),
    'okolor': ('container-oil-heart', 3),
    'qotoy': ('basin-of-ADJ', 3),
    'ykoaiin': ('and-vessel-of.NOM', 3),
    'chekeol': ('flower-vessel-oil', 3),
    'chodair': ('flower-a-leaf-tree', 3),
    'sheam': ('water-flow.GEN', 3),
    'ytoy': ('and-time-of-ADJ', 3),
    'pydaiin': ('for-ADJ-leaf.NOM', 3),
    'shytchy': ('water-ADJ-time-with-ADJ', 3),
    'cpholdy': ('with-for-oil-ADJ', 3),
    'koraiin': ('vessel-heart.NOM', 3),
    'sheyr': ('water-flow-tree', 3),
    'kchoy': ('vessel-with-of-ADJ', 3),
    'cphody': ('with-for-a-ADJ', 3),
    'torchy': ('time-heart-with-ADJ', 3),
    'cthory': ('condition-heart-ADJ', 3),
    'qokoy': ('vessel-vessel-of-ADJ', 3),
    'ochody': ('of-with-a-ADJ', 3),
    'chykey': ('flower-ADJ-vessel-flow', 3),
    'chtody': ('flower-time-a-ADJ', 3),
    'olsy': ('oil-root-ADJ', 3),
    'cholols': ('flower-oil-oil-root', 3),
    'qotoeey': ('basin-of-flow', 3),
    'cheotol': ('flower-of-celestial', 3),
    'foar': ('beast-of-tree', 3),
    'chotols': ('flower-time-oil-root', 3),
    'kshor': ('vessel-water-heart', 3),
    'ctheod': ('condition-flow-leaf', 3),
    'ychar': ('and-with-tree', 3),
    'qocthol': ('vessel-condition-oil', 3),
    'qokom': ('vessel-vessel-EYE', 3),
    'ychear': ('and-with-flow-tree', 3),
    'ytchos': ('and-time-flower-bone', 3),
    'ytcho': ('and-time-flower', 3),
    'kchos': ('vessel-with-bone', 3),
    'fchodaiin': ('beast-with-leaf.NOM', 3),
    'shopchey': ('water-for-with-flow', 3),
    'daiinychey': ('leaf.NOM-and-with-flow', 3),
    'dykchy': ('leaf-ADJ-vessel-with-ADJ', 3),
    'dchodaiin': ('leaf-with-leaf.NOM', 3),
    'chofchy': ('flower-of-beast-with-ADJ', 3),
    'chocty': ('flower-with-time-ADJ', 3),
    'choor': ('flower-of-heart', 3),
    'ocho': ('of-with-of', 3),
    'otariin': ('star-tree.NOM', 3),
    'kchokchy': ('vessel-with-vessel-with-ADJ', 3),
    'chsey': ('flower-root-flow', 3),
    'cky': ('with-vessel-ADJ', 3),
    'cha': ('flower-a', 3),
    'cheain': ('flower-water.ACC', 3),
    'okalchal': ('container-high-with-high', 3),
    'sorain': ('root-heart.ACC', 3),
    'otorchy': ('star-heart-with-ADJ', 3),
    'chodey': ('flower-a-flow', 3),
    'toiin': ('time-of.NOM', 3),
    'qotod': ('basin-of-leaf', 3),
    'chokcho': ('flower-vessel-with-of', 3),
    'qofol': ('vessel-beast-oil', 3),
    'odol': ('of-a-oil', 3),
    'qochol': ('vessel-with-oil', 3),
    'pchodol': ('for-with-a-oil', 3),
    'kom': ('vessel-EYE', 3),
    'dychy': ('leaf-ADJ-with-ADJ', 3),
    'qodor': ('vessel-a-heart', 3),
    'shcphy': ('water-with-for-ADJ', 3),
    'torshor': ('time-heart-water-heart', 3),
    'shkchy': ('water-vessel-with-ADJ', 3),
    'qodchy': ('vessel-a-with-ADJ', 3),
    'dpchy': ('leaf-for-with-ADJ', 3),
    'octhos': ('of-condition-bone', 3),
    'qocky': ('vessel-with-vessel-ADJ', 3),
    'olcphy': ('oil-with-for-ADJ', 3),
    'oir': ('of-in-tree', 3),
}
